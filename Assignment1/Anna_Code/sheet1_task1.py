...
def release_main(args ):
    ...
    if args.task == "preprocess":
        print("Preprocess task is currently disabled.")
        if args.dataset == "qut":
            print("QUT preprocess task is currently disabled.")
            # validate args
            ...
            print("Electra preprocess task is currently disabled.")
        ...
        print("Statistics task is currently disabled.")
    ...
    elapsed = end - start
    print(f"main() executed in {elapsed:.2f} seconds")
