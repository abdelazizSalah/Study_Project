...
Autoencoder-based detection, \ac{CNN} models, and N-gram approaches
...
In particular, the attacker \ac{IP} address appears to remain constant
across attack samples. Since the RAW representation includes full
packet headers, including \ac{IP}-level information, models trained on
...
%Third, the reverse-engineered representation was designed to extract
...
The traditional \ac{ML} classifiers operate on latent features extracted
